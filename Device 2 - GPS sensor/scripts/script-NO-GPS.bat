...
adb shell am start -n "es.uma.caosd.josemi.testbattery/es.uma.caosd.josemi.testbattery.MainActivity" -a android.intent.action.MAIN -c android.intent.category.LAUNCHER
...
adb shell am force-stop es.uma.caosd.josemi.testbattery
